...
type NodeConfig struct {
	...
	HttpAddress         string                     `comment:"Listen address for admin rest requests and web interface. Default is to listen for local\nconnections on TCP/19019. To disable\nthe admin rest interface, use the value \"none\" instead.\nExample: http://localhost:19019."`
	WwwRoot             string                     `comment:"Points out to webserver root folder path where web interface assets are located.

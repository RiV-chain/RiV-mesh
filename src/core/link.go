...
func (l *links) handler(linkType linkType, options linkOptions, conn net.Conn, success func()) error {
	...
	remoteAddr := net.IP(l.core.AddrForDomain(meta.domain)[:]).String()
	...
	err = l.core.HandleConn(meta.domain, conn, priority)
	switch err {
